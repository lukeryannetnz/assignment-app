...
namespace Tests\Domains\IdentityAccess\Feature;
...
class AdminUserManagementTest extends TestCase
{
    ...
    {
        $response = $this->get('/admin/identity-access/users');
    ...
    public function testUserManagementPageRequiresAdminRole(): void
    {
        ...
        $response = $this->actingAs($student)->get('/admin/identity-access/users');
    ...
    public function testUserManagementPageDisplaysUsers(): void
    {
        ...
        $response = $this->actingAs($admin)->get('/admin/identity-access/users');
    ...
    public function testAdminCanPromoteUserToAdmin(): void
    {
        ...
        $response = $this->actingAs($admin)->post("/admin/identity-access/users/{$student->id}/promote");

        $response->assertRedirect('/admin/identity-access/users');
    ...
    public function testPromoteRequiresAuthentication(): void
    {
        ...
        $response = $this->post("/admin/identity-access/users/{$student->id}/promote");
    ...
    public function testPromoteRequiresAdminRole(): void
    {
        ...
        $response = $this->actingAs($student1)->post("/admin/identity-access/users/{$student2->id}/promote");
    ...
    public function testPromoteReturns404ForNonexistentUser(): void
    {
        ...
        $response = $this->actingAs($admin)->post('/admin/identity-access/users/99999/promote');
    ...
    public function testAdminCanDemoteUserFromAdmin(): void
    {
        ...
        $response = $this->actingAs($admin1)->post("/admin/identity-access/users/{$admin2->id}/demote");
    ...
    public function testDemoteRequiresAuthentication(): void
    {
        ...
        $response = $this->post("/admin/identity-access/users/{$admin->id}/demote");
    ...
    public function testDemoteRequiresAdminRole(): void
    {
        ...
        $response = $this->actingAs($student)->post("/admin/identity-access/users/{$admin->id}/demote");
    ...
    public function testAdminCannotDemoteThemselves(): void
    {
        ...
        $response = $this->actingAs($admin)->post("/admin/identity-access/users/{$admin->id}/demote");
    ...
    public function testDemoteReturns404ForNonexistentUser(): void
    {
        ...
        $response = $this->actingAs($admin)->post('/admin/identity-access/users/99999/demote');
    ...
    public function testUserListShowsDemoteButtonForOtherAdmins(): void
    {
        ...
        $response = $this->actingAs($admin1)->get('/admin/identity-access/users');
