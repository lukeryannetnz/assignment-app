...
class CurriculumTest extends TestCase
{
    ...
    public function testSectionIndexPageRequiresAuthentication(): void
    {
        ...
        $response = $this->get(route('curriculum.admin.sections.index', $course->id));
    ...
    public function testSectionIndexPageRequiresAdminRole(): void
    {
        ...
        $response = $this->actingAs($student)->get(route('curriculum.admin.sections.index', $course->id));
    ...
    public function testSectionIndexDisplaysSections(): void
    {
        ...
        $response = $this->actingAs($this->admin)->get(route('curriculum.admin.sections.index', $course->id));
    ...
    public function testCanCreateSection(): void
    {
        ...
        $response = $this->actingAs($this->admin)->post(route('curriculum.admin.sections.store', $course->id), [
            'title' => 'Getting Started',
            'order' => 1,
        ]);

        $response->assertRedirect(route('curriculum.admin.sections.index', $course->id));
    ...
    public function testCanUpdateSection(): void
    {
        ...
        $response = $this->actingAs($this->admin)->put(
            route('curriculum.admin.sections.update', [$course->id, $section->id]),
            [
                'title' => 'New Title',
                'order' => 2,
            ]
    ...
    public function testCanDeleteSection(): void
    {
        ...
        $response = $this->actingAs($this->admin)
            ->delete(route('curriculum.admin.sections.destroy', [$course->id, $section->id]));
    ...
    public function testCanCreateQuizWithQuestions(): void
    {
        ...
        $response = $this->actingAs($this->admin)->post(route('curriculum.admin.items.store', $section->id), $quizData);

        $response->assertRedirect(route('curriculum.admin.sections.index', $section->course_id));
    ...
    public function testQuizDurationCalculatedBasedOnQuestionCount(): void
    {
        ...
        $this->actingAs($this->admin)->post(route('curriculum.admin.items.store', $section->id), $quizData);
    ...
    public function testCanUpdateQuiz(): void
    {
        ...
        $response = $this->actingAs($this->admin)
            ->put(route('curriculum.admin.items.update', [$section->id, $item->id]), $updateData);
    ...
    public function testCanDeleteQuiz(): void
    {
        ...
        $response = $this->actingAs($this->admin)
            ->delete(route('curriculum.admin.items.destroy', [$section->id, $item->id]));
