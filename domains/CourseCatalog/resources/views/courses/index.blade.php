                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ route('course-catalog.courses.show', $course->id) }}" class="inline-flex items-center px-3 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700">
                                        View Details
                                    </a>
                                    ...
                                    @else
                                        <form method="POST" action="{{ route('enrollment.enroll', $course->id) }}" class="inline">
                                            @csrf
