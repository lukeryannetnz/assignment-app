<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ url('/') }}">
                        <x-course-catalog::graduation-cap-logo class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" />
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-course-catalog::nav-link :href="route('course-catalog.dashboard')" :active="request()->routeIs('course-catalog.dashboard')">
                        {{ __('Dashboard') }}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-course-catalog::dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-course-catalog::dropdown-link :href="route('identity-access.profile.edit')">
                            {{ __('Profile') }}
                        ...
                        <form method="POST" action="{{ route('identity-access.auth.logout') }}">
                            ...
                            <x-course-catalog::dropdown-link :href="route('identity-access.auth.logout')"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-course-catalog::responsive-nav-link :href="route('course-catalog.dashboard')" :active="request()->routeIs('course-catalog.dashboard')">
                {{ __('Dashboard') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <x-course-catalog::responsive-nav-link :href="route('identity-access.profile.edit')">
                    {{ __('Profile') }}
                </x-course-catalog::responsive-nav-link>
                ...
                <form method="POST" action="{{ route('identity-access.auth.logout') }}">
                    ...
                    <x-course-catalog::responsive-nav-link :href="route('identity-access.auth.logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-course-catalog::responsive-nav-link>
