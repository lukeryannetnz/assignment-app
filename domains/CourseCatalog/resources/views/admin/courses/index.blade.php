<x-course-catalog::app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('course-catalog.admin.courses.create') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700">
                Create New Course
            </a>
        </div>
    </x-slot>
                            ...
                            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:shadow-lg transition-shadow">
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="flex gap-2 ml-4">
                                        <a href="{{ route('curriculum.admin.sections.index', $course->id) }}"
                                        ...
                                        <a href="{{ route('course-catalog.admin.courses.edit', ['id' => $course->id, 'page' => $courses->currentPage()]) }}"
                                        ...
                                        <form method="POST" action="{{ route('course-catalog.admin.courses.destroy', $course->id) }}"
