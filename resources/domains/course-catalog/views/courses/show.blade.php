                ...
                <div class="p-6">
                    ...
                    <div class="flex gap-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                        @if($isEnrolled)
                            ...
                            <form method="POST" action="{{ route('enrollment.unenroll', $course->id) }}"
                        ...
                        @endif
                        <a href="{{ route('course-catalog.courses.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 dark:bg-gray-700 border border-transparent rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest hover:bg-gray-400 dark:hover:bg-gray-600">
                            Back to Courses
                        </a>
                    </div>
                </div>
